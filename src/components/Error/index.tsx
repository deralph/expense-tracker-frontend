...
const Error:React.FC = () => {
  return (
    <section className="flex justify-evenly items-center text-center font-sans bg-primary min-h-[100vh] p-5 slg:flex-col slg:h-auto slg:overflow-hidden slg:pb-10">
      ...
      <div className="w-full max-w-[500px] big:max-w-[40vw]">
        ...
        <Link to="/" className="text-lg py-4 px-10 bg-white text-primary font-bold rounded-[30px] big:text-[50px] big:py-5 big:px-20 sm:p-4 sm:text-base">Go to homePage</Link>
      </div>
    </section>
  );
};
