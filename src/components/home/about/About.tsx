  ...
  return (
    <section className="big:my-[100px] big:mx-auto" id="about">
      ...
      <article className="flex justify-evenly items-center w-full big:my-[100px] big:mx-auto md:flex-col">
        <div className="basis-[45%] md:basis-2/5">
          <h4 className="text-[30px] font-sans text-center text-[#96f] relative big:text-4xl">ExpensedTracked</h4>
          <p className="text-[30px] p-5">
